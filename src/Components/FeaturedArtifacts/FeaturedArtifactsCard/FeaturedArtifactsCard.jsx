...
const FeaturedArtifactsCard = ({ artifact, handleLike }) => {
    ...
    return (
        <div className="cinzel-font bg-gray-100 dark:bg-[#2a2d3f] rounded-lg overflow-hidden transform hover:scale-105 transition-all duration-700 animate__animated animate__fadeInUp shadow-[0_0_13px_#000] dark:shadow-[0_0_10px_#fff]">
